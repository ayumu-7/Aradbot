...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "arad") || (event.body.toLowerCase() == "Anbir Arad") || (event.body.toLowerCase() == "Rakib") || (event.body.toLowerCase() == "prince")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞𝔄𝔯𝔞𝔡 𝔬𝔯 ℜ𝔞𝔨𝔦𝔟☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ℝ𝕒𝕜𝕚𝕓🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ https://www.facebook.com/RAKIB.404X\n👋For Any Kind Of Help Contact On Telegram  Username 👉 @RAKIBX😇", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("𝚁𝚊𝚔𝚒𝚋 𝚒𝚜  ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot er admin k")) {
     return api.sendMessage("He is Rakib. He Gives his name Rakib everywhare", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "stop") || (event.body.toLowerCase() == "chup ho ja") || (event.body.toLowerCase() == "chup kor")) {
     return api.sendMessage("Nhi rahunga. 😼 Mujhe Bolna H. Tumhe Koi Haq nhi Mujhe Chup Karane ka. Mera Zuban. Ami bolboi", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "nice") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thank you bot") || (event.body.toLowerCase() == "thank you Jinwoo")) {
   ...
   if ((event.body.toLowerCase() == "hm") || (event.body.toLowerCase() == "hmm")) {
     return api.sendMessage("️Hmm Hmm Na Karke Sidha Sidha bolo. Hey Rakib Marry Me🙈", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bot k bacche") || (event.body.toLowerCase() == "bot er bacche")) {
     return api.sendMessage("️meri baccha toh Tumhare Pet Me Hai.", threadID);
   };

   if ((event.body.toLowerCase() == "pic do") || (event.body.toLowerCase() == "pic daw")) {
     return api.sendMessage("️Me toh Andha Hu Dekh nhi sakta", threadID);
   };

   if ((event.body.toLowerCase() == "Alhamdulillah❤️‍🩹") || (event.body.toLowerCase() == "Hlw") || (event.body.toLowerCase() == "Assalamu Alaikum")) {
    return api.sendMessage("️Alhamdulillah. kaise hya aap? 😇. Walaikum Assalam", threadID);
   };

   if ((event.body.toLowerCase() == "bot banai daw") || (event.body.toLowerCase() == "amro lagbe")) {
     return api.sendMessage("️Khud hi karlona. tumhe kya kuch nhi ata h?", threadID);
   };

   if ((event.body.toLowerCase() == "🙂") || (event.body.toLowerCase() == "🙃")) {
     return api.sendMessage("️Senti na khay vaat kha. Khaile mota hobi gadha", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
   ...
   if ((event.body.toLowerCase() == "kese ho") || (event.body.toLowerCase() == "kmn achos") || (event.body.toLowerCase() == "kemon acho") || (event.body.toLowerCase() == "how are you") || (event.body.toLowerCase() == "how are you?")) {
  ...
  if ((event.body.toLowerCase() == "lap you") || (event.body.toLowerCase() == "i lap you")) {
     return api.sendMessage("Lap You too😗💦", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "&fuck") || (event.body.toLowerCase() == "&Fuck")) {
     return api.sendMessage("🏔️🏝️Rakib Ƞɛ ꌗƥɛçɪɑɭɭɣ Ƭuɱ 🌊🪺Jɑɪʂɛ Ƭɧɑɽƙɪɣɵ Ƙɛ Ɬɪɣɛ•• 🏞️🌬️Ɣɑɧ çɵɱɱɑƞɗ Ɦɑʈɑ Ɗɪɣɑ Ɦɑɪ↗↘ Sɵɽɽɣ Ɠɣuʂ••😹🫶", threadID);
   };

  if ((event.body.toLowerCase() == "ami rakib") || (event.body.toLowerCase() == "ami arad") || (event.body.toLowerCase() == "main arad") || (event.body.toLowerCase() == "main rakib") || (event.body.toLowerCase() == "main adil")) {
